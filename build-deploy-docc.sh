...
# --- Config ---
BUILD_SCHEME_NAME=TinyTBDeviceClient
SCP_DESTINATION_URL=scp://$SCPUSER@kinzigdoccserver:22/kinzig-developer-docs_com/tinytbdeviceclient/
WWW_URL=https://tinytbdeviceclient.kinzig-developer-docs.com/documentation/tinytbdeviceclient
