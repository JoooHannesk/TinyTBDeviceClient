...
A minimal, pragmatic MQTT client built on NIO MQTT, pre-configured for ThingsBoard device connectivity. Secure by default with mandatory TLS and CA pinning.
