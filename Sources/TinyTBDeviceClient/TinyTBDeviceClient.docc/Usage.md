# Usage
Sample implementation making use of this library


## Reference Implementation
- A reference implementation making use of this library is presented under a dedicated git repository: [https://github.com/JoooHannesk/TinyTBDeviceClient-Example](https://github.com/JoooHannesk/TinyTBDeviceClient-Example)
- The sample implementation mainly consists of two files showcasing the library's features and functionality:
    - [main.swift](https://github.com/JoooHannesk/TinyTBDeviceClient-Example/blob/main/Sources/TinyTBDeviceClient-Example/main.swift)
    - [RPCMessageProcessor.swift](https://github.com/JoooHannesk/TinyTBDeviceClient-Example/blob/main/Sources/TinyTBDeviceClient-Example/RPCMessageProcessor.swift)
- Both files are shown here for convenience
